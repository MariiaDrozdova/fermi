...
prefix = 'sky1' # all output files will start from prefix_
...
data_path = '/media/masha/583D-548B/'#'/home/tu/tu_tu/tu_pside01/FERMI/Data/Variable/All/' #path to Fermi/LAT data
...
gti = prefix + '_events.fits' # event-file name
sky_map = prefix+'_real_map.fits' # sky map
expcube = prefix+'_expCube.fits'
bexpmap = prefix+'_BexpMap.fits'
ccubemap = prefix+'_ccube3D.fits'
srcmap = prefix+'_SrcMap.fits'
srcmdl = prefix+'_src_model_const.xml' # xml version of the  model map
model_map = prefix+'_model_map.fits' # model map
deconv_map = prefix + '_deconvolved_map.fits' # "ideal deconvolution" map

tmp_gti = prefix+'_events.tmp' #temp event-file name
tmp_evlist = prefix+'_evlist.tmp' #temp
